    ...
    <div className="p-6 max-w-7xl mx-auto pb-24">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white dark:bg-gray-900 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 text-center">
          ...
          <h2 className="text-xl font-bold text-gray-900 dark:text-white">Alex Doe</h2>
          <p className="text-gray-500 dark:text-gray-400 mb-6">Computer Science Major</p>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
             <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-100 dark:border-gray-800 flex flex-col items-center text-center">
                ...
                <span className="text-3xl font-bold text-gray-900 dark:text-white">42h</span>
             ...
             <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-100 dark:border-gray-800 flex flex-col items-center text-center">
                ...
                <span className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-wide mt-1">Lectures Watched</span>
             </div>
          </div>

          <div className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-100 dark:border-gray-800">
             <h4 className="font-bold text-gray-800 dark:text-white mb-4">Recent Achievements</h4>
